...
export const meta = () => [
  { title: "Elaach | Simple, extensible, open-source project management tool." },
  ...
  { property: "og:title", content: "Elaach | Simple, extensible, open-source project management tool." },
  {
