export default {
  ...
  support: "Support",
  discord: "Discord",
  powered_by_plane_pages: "Powered by Elaach Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Most things start with a project in Elaach.",
        cta: "Get started",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "To start using Elaach, you need to create or join a workspace.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Welcome to Elaach, we are excited to have you here. Create your first project and track your work items, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
        primary_button: {
          text: "Build your first project",
          comic: {
            title: "Everything starts with a project in Elaach",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copy and save this secret key in Elaach Pages. You can't see this key after you hit Close. A CSV file containing the key has been downloaded.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Any application using this token will no longer have the access to Elaach data. This action cannot be undone.",
          success: {
            title: "Success!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Elaach APIs can be used to integrate your data in Elaach with any external system. Create a token to get started.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Get started by creating a new work item! Add details and properties to it. Explore more in Elaach to see your activity.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Elaach will auto archive work items that have been completed or canceled.",
        duration: "Auto-archive work items that are closed for",
      },
      "auto-close": {
        title: "Auto-close work items",
        description: "Elaach will automatically close work items that haven't been completed or canceled.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Work items are building blocks in Elaach.",
            description:
              "Redesign the Elaach UI, Rebrand the company, or Launch the new fuel injection system are examples of work items that likely have sub-work items.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Write a note, a doc, or a full knowledge base. Get Galileo, Elaach's AI assistant, to help you get started",
        description:
          "Pages are thoughts potting space in Elaach. Take down meeting notes, format them easily, embed work items, lay them out using a library of components, and keep them all in your project's context. To make short work of any doc, invoke Galileo, Elaach's AI, with a shortcut or the click of a button.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Elaach didn't start up. This could be because one or more Elaach services failed to start.",
  ...
  power_k: {
    ...
    //   open_plane_documentation: "Open Elaach documentation",
